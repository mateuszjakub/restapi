...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public JsonObjectAuthenticationFlter authenticationFilter() throws Exception {
        JsonObjectAuthenticationFlter authenticationFilter = new JsonObjectAuthenticationFlter(objectMapper);
